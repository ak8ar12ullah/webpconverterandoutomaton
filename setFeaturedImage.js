...
export async function setFeaturedImage(browser, postId, imageFilename) {
  ...
  try {
    ...
    if (hasFeaturedImage) {
      ...
      const imageWp = hapusResolusiWp(
        hapusAngkaAkhirExt(ambilAkiranUrl(imageSrc))
      );
      console.log("image file name " + imageFilename);
      console.log("imageWp " + imageWp);
      if (imageWp !== imageFilename) throw new Error("image berbeda");
...
// Contoh pemanggilan
setFeaturedImage(browser, 6641, "manhole-banyumas-dinperkim.webp");
